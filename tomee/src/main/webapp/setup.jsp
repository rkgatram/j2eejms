...
--%>
<%@ page import="com.boxfuse.samples.tomee.Movie" %>
<%@ page import="com.boxfuse.samples.tomee.MoviesBean" %>
...
<%
  ...
  MoviesBean moviesBean = (MoviesBean) initialContext.lookup("java:comp/env/com.boxfuse.samples.tomee.ActionServlet/moviesBean");
